        ...
        stage('Terraform Init'){
            ...
            steps {
                    ...
                    tenantIdVariable: 'ARM_TENANT_ID'
                        ...
                        terraform init -backend=true  -backend-config="storage_account_name=$BACKEND_STORAGE_ACCOUNT_NAME" -backend-config="container_name=$BACKEND_STORAGE_ACCOUNT_CONTAINER_NAME" -backend-config="key=$BACKEND_KEY" -backend-config="resource_group_name=$RG_NAME"
                        """
                        }
                     }
                }
