        ...
        stage('Terraform Plan'){
            ...
            steps {
                    ...
                    tenantIdVariable: 'ARM_TENANT_ID'
                        ...
                        terraform plan -var-file="default.tfvars"-var "client_id=$ARM_CLIENT_ID" -var "client_secret=$ARM_CLIENT_SECRET" -var "subscription_id=$ARM_SUBSCRIPTION_ID" -var "tenant_id=$ARM_TENANT_ID"
                        """
                        }
                }
                }
